      ...
      return (
        <div className="enter-from-right slide-in">
          ...
          <CardActions style={{ ...spaceBetweenStyle, float: 'center' }}>
            ...
            <Button size="large" variant="contained" color="primary" style={{ marginLeft: '4vw' }} onClick={this.login} disabled={!(this.state.isValidNewPassword && this.state.isValidConfirmPassword && this.state.cpassword && this.state.password)}>
              Next
              </Button>
          </CardActions>
        </div>
